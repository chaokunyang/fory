...
- **Handle complex problems and never workaround it**: always remember that never and never work around the problems, you should always tackle and resolve tricky and complex problems
- **Use smart pointers instead of raw pointers for C++**: don't use raw pointers in C++, use smart pointers instead.
