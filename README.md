...
[![Crates.io](https://img.shields.io/badge/crates.io-v1.7.5-blue?logo=rust&style=for-the-badge)](https://crates.io/crates/fory)
...
```kotlin
implementation("org.apache.fory:fory-kotlin:1.7.5")
```
...
```bazel
# MODULE.bazel
bazel_dep(name = "fory", version = "1.7.5")
git_override(module_name = "fory", remote = "https://github.com/apache/fory.git", commit = "v1.7.5")
...
```swift
dependencies: [
  .package(url: "https://github.com/apache/fory.git", exact: "1.7.5")
],
targets: [
  .target(
    name: "YourTarget",
