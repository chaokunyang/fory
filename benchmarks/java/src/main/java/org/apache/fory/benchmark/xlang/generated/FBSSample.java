...
public final class FBSSample extends Table {
  ...
  public int shortValue() { int o = __offset(12); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public int charValue() { int o = __offset(14); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public int shortValueBoxed() { int o = __offset(26); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public int charValueBoxed() { int o = __offset(28); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public int shortArray(int j) { int o = __offset(40); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int shortArrayLength() { int o = __offset(40); return o != 0 ? __vector_len(o) : 0; }
  public IntVector shortArrayVector() { return shortArrayVector(new IntVector()); }
  public IntVector shortArrayVector(IntVector obj) { int o = __offset(40); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  public ByteBuffer shortArrayAsByteBuffer() { return __vector_as_bytebuffer(40, 4); }
  public ByteBuffer shortArrayInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 4); }
  public int charArray(int j) { int o = __offset(42); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int charArrayLength() { int o = __offset(42); return o != 0 ? __vector_len(o) : 0; }
  public IntVector charArrayVector() { return charArrayVector(new IntVector()); }
  public IntVector charArrayVector(IntVector obj) { int o = __offset(42); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  public ByteBuffer charArrayAsByteBuffer() { return __vector_as_bytebuffer(42, 4); }
  public ByteBuffer charArrayInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 42, 4); }
  ...
  public static int createFBSSample(FlatBufferBuilder builder,
      ...
      int short_value_boxed,
      int char_value_boxed,
  ...
  public static void addShortValue(FlatBufferBuilder builder, int shortValue) { builder.addInt(4, shortValue, 0); }
  public static void addCharValue(FlatBufferBuilder builder, int charValue) { builder.addInt(5, charValue, 0); }
  ...
  public static void addShortValueBoxed(FlatBufferBuilder builder, int shortValueBoxed) { builder.addInt(11, shortValueBoxed, 0); }
  public static void addCharValueBoxed(FlatBufferBuilder builder, int charValueBoxed) { builder.addInt(12, charValueBoxed, 0); }
  ...
  public static int createShortArrayVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addInt(data[i]); return builder.endVector(); }
  public static void startShortArrayVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addCharArray(FlatBufferBuilder builder, int charArrayOffset) { builder.addOffset(19, charArrayOffset, 0); }
  public static int createCharArrayVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addInt(data[i]); return builder.endVector(); }
  public static void startCharArrayVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
