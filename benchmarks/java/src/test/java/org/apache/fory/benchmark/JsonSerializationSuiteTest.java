...
import org.apache.fory.benchmark.JsonSerializationSuite.BlackbirdState;
...
public class JsonSerializationSuiteTest {
  @Test
  public void testJacksonVariants() throws IOException {
    ...
    BlackbirdState blackbird = new BlackbirdState();
    blackbird.setup();
    assertBlackbird(blackbird, suite);
  }
  ...
  private static void assertBlackbird(BlackbirdState state, JsonSerializationSuite suite) {
    MediaContent fromBytes =
