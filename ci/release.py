...
def bump_java_version(new_version):
    ...
    for p in [
        ...
        "java/fory-core",
        "java/fory-json",
        "java/fory-json-extension",
        "java/fory-json-extension/fory-json-spring",
        "java/fory-json-extension/fory-json-spring6",
        "java/fory-json-extension/fory-json-spring-boot-starter",
        "java/fory-json-extension/fory-json-spring-boot3-starter",
        "java/fory-format",
