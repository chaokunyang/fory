...
def test_csharp_container_field_encoding_attributes():
    ...
    assert "[Field(Id = 1, Encoding = FieldEncoding.Fixed)]" in file.content
    assert "[Field(Id = 2, Encoding = FieldEncoding.Varint)]" in file.content
    assert "[Field(Id = 3, Encoding = FieldEncoding.Tagged)]" in file.content
    assert "[Field(Id = 4, Encoding = FieldEncoding.Fixed)]" in file.content
    assert "[Field(Id = 5, Encoding = FieldEncoding.Varint)]" in file.content
    assert "[Field(Id = 6, Encoding = FieldEncoding.Tagged)]" in file.content
    assert "[Field(Id = 7, Encoding = FieldEncoding.Tagged)]" in file.content
