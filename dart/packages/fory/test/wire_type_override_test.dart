...
class WireTypeOverrideFields {
  ...
  @ForyField(type: Uint8ArrayType())
  Uint8List uint8Array = Uint8List(0);

  @MapField(
    key: Int32Type(encoding: Encoding.fixed),
    value: Uint32Type(encoding: Encoding.fixed),
  )
  Map<int, int> fixedMap = <int, int>{};
