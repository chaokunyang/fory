...
| gRPC ecosystem     | Native                        | Java/Python/Go/Rust service codegen   |
...
```bash
foryc api.proto --java_out=./generated/java --python_out=./generated/python --rust_out=./generated/rust --grpc
```
