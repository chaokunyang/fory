...
outputs such as Java, Python, Go, Rust, Kotlin, and JavaScript. JavaScript
browser gRPC-Web clients are generated with `--grpc-web`.
...
- The generated gRPC companions use Fory serialization for each RPC payload.
  ...
  and `bytes`, `@grpc/grpc-js`, or `grpc-web`.
