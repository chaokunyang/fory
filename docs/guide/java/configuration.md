...
| `maxSchemaVersionsPerType`          | Maximum accepted remote struct schema versions for one logical type before Fory rejects additional remote metadata on cache misses.                                                                                                                                                                                                                                                                                                                                                                                                           | `10`                                                                 |
| `maxAverageSchemaVersionsPerType`   | Average accepted remote struct schema versions across all accepted remote struct types. The effective global floor is `8192` schemas.                                                                                                                                                                                                                                                                                                                                                                                                         | `3`                                                                  |
...
- `withMaxSchemaVersionsPerType(...)` and
  `withMaxAverageSchemaVersionsPerType(...)` bound remote struct metadata cache
  misses without changing registration, dynamic loading, or schema-evolution
  semantics.
