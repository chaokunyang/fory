...
| `maxGraphMemoryBytes`               | Maximum estimated shallow graph memory accepted during one root deserialization. `-1` derives an automatic limit from the input shape: known-length inputs use `inputBytes * 8 + 64 KiB`, and stream or unknown-length inputs use `128 MiB`. Positive values set an explicit byte limit.                                                                                                                                                                                                                                                      | `-1`                                                                 |
