...
declarations directly. It generates the default configuration baseline plus additions from
reachable providers, while exact misses use interpreted codecs. See the
