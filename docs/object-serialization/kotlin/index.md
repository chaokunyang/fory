---
title: Kotlin Object Serialization
sidebar_position: 0
id: index
license: |
...
optional but recommended. It avoids the current-JDK Unsafe fallback and is required when Unsafe
...
See [Configuration](configuration.md) for Kotlin builder setup and [Java Native Serialization](../java/native.md) for the full JVM native-mode behavior.
