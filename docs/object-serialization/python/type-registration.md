...
The first root serialization or deserialization attempt permanently freezes the
instance's registry, including when that attempt fails. `strict=False` relaxes
