---
title: Scala Object Serialization
sidebar_position: 0
id: index
license: |
...
See [Configuration](configuration.md) for Scala builder setup and [Java Native Serialization](../java/native.md) for the full JVM native-mode behavior.
