...
| bfloat16                | 18           | BFloat16        | pyfory.bfloat16          | /                   | `fory::bfloat16_t`             | /                | `BFloat16`        |
...
| float8_array            | 52           | /               | /                        | /                   | /                              | /                | /                 |
| float16_array           | 53           | Float16List     | ndarray(float16)         | /                   | `fory::float16_t[n]/vector<T>` | `[n]float16/[]T` | `Vec<fory::f16>` / `[Float16; N]` |
| bfloat16_array          | 54           | BFloat16List    | pyfory.bfloat16array     | /                   | `fory::bfloat16_t[n]/std::vector<fory::bfloat16_t>` | / | `Vec<BFloat16>` / `[BFloat16; N]` |
