...
go get github.com/apache/fory/go/fory@v1.7.5
```
...
Use [xlang mode](../object-serialization/go/basic-serialization.md#cross-language-interoperability) for cross-language data
