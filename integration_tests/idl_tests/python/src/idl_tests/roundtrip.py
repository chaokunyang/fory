...
def build_optional_holder() -> "optional_types.OptionalHolder":
    all_types = optional_types.AllOptionalTypes(
        bool_value=True,
        int8_value=pyfory.int8(12),
        int16_value=pyfory.int16(1234),
        int32_value=pyfory.int32(-123456),
        fixed_int32_value=pyfory.fixed_int32(-123456),
        varint32_value=pyfory.int32(-12345),
        int64_value=pyfory.int64(-123456789),
        fixed_int64_value=pyfory.fixed_int64(-123456789),
        varint64_value=pyfory.int64(-987654321),
        tagged_int64_value=pyfory.tagged_int64(123456789),
        uint8_value=pyfory.uint8(200),
        uint16_value=pyfory.uint16(60000),
        uint32_value=pyfory.uint32(1234567890),
        fixed_uint32_value=pyfory.fixed_uint32(1234567890),
        var_uint32_value=pyfory.uint32(1234567890),
        uint64_value=pyfory.uint64(9876543210),
        fixed_uint64_value=pyfory.fixed_uint64(9876543210),
        var_uint64_value=pyfory.uint64(12345678901),
        tagged_uint64_value=pyfory.tagged_uint64(2222222222),
        float16_value=pyfory.float32(1.5),
        float32_value=pyfory.float32(2.5),
        float64_value=pyfory.float64(3.5),
        string_value="optional",
        bytes_value=b"\x01\x02\x03",
        date_value=datetime.date(2024, 1, 2),
        timestamp_value=datetime.datetime(2024, 1, 2, 3, 4, 5, tzinfo=datetime.timezone.utc),
        int32_list=np.array([1, 2, 3], dtype=np.int32),
        string_list=["alpha", "beta"],
        int64_map={"alpha": pyfory.int64(10), "beta": pyfory.int64(20)},
    )
