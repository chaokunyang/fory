...
unset DATA_FILE
unset DATA_FILE_AUTO_ID
unset DATA_FILE_PRIMITIVES
unset DATA_FILE_COLLECTION
unset DATA_FILE_COLLECTION_UNION
unset DATA_FILE_COLLECTION_ARRAY
unset DATA_FILE_COLLECTION_ARRAY_UNION
unset DATA_FILE_OPTIONAL_TYPES
unset DATA_FILE_ANY
unset DATA_FILE_ANY_PROTO
unset DATA_FILE_TREE
unset DATA_FILE_GRAPH
unset DATA_FILE_FLATBUFFERS_MONSTER
unset DATA_FILE_FLATBUFFERS_TEST2
unset DATA_FILE_ROOT

IDL_PEER_LANG=csharp "${SCRIPT_DIR}/run_java_tests.sh"
