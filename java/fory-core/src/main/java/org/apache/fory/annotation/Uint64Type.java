 ...
 *
 * <ul>
 *   <li>With {@link LongEncoding#VARINT64}: skips zigzag encoding overhead for non-negative values
 *   <li>With {@link LongEncoding#TAGGED_INT64}: uses unsigned range [0, 2147483647] for 4-byte
