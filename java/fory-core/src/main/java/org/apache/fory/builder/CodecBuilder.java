...
public abstract class CodecBuilder {
  ...
  protected Expression buildDefaultComponentsArray() {
    return new StaticInvoke(
        UnsafeSupport.class, "copyObjectArray", OBJECT_ARRAY_TYPE, recordComponentDefaultValues);
  }
  ...
  private Expression unsafeAccessField(
    ...
    if (descriptor.getTypeRef().isPrimitive()) {
      // ex: UnsafeSupport.UNSAFE.getFloat(obj, fieldOffset)
      ...
      return new StaticInvoke(
          UnsafeSupport.class, funcName, returnType, false, inputObject, fieldOffsetExpr);
    } else {
      // ex: UnsafeSupport.UNSAFE.getObject(obj, fieldOffset)
      StaticInvoke getObj =
          new StaticInvoke(
              UnsafeSupport.class,
              "getObject",
    ...
    if (GraalvmSupport.isGraalBuildTime()) {
      return getOrCreateField(
          ...
          () -> {
            ...
            return new StaticInvoke(
                    UnsafeSupport.class, "objectFieldOffset", PRIMITIVE_LONG_TYPE, reflectFieldRef)
                .inline();
          });
    } else {
  ...
  private Expression unsafeSetField(Expression bean, Descriptor descriptor, Expression value) {
    ...
    if (descriptor.getTypeRef().isPrimitive()) {
      ...
      return new StaticInvoke(UnsafeSupport.class, funcName, bean, fieldOffsetExpr, value);
    } else {
      return new StaticInvoke(UnsafeSupport.class, "putObject", bean, fieldOffsetExpr, value);
    }
  }
  ...
  protected Expression newBean() {
    ...
    if (sourcePublicAccessible(beanClass)) {
      ...
      if (GraalvmSupport.IN_GRAALVM_NATIVE_IMAGE && UnsafeSupport.JAVA_VERSION >= 25) {
      ...
      return new StaticInvoke(UnsafeSupport.class, "newInstance", OBJECT_TYPE, beanClassExpr());
    }
  }
  ...
  protected Expression unsafeGetShort(Expression base, Expression pos) {
    StaticInvoke expr =
        new StaticInvoke(UnsafeSupport.class, "getShort", PRIMITIVE_SHORT_TYPE, base, pos);
    if (!UnsafeSupport.IS_LITTLE_ENDIAN) {
  ...
  protected Expression unsafeGetInt(Expression base, Expression pos) {
    StaticInvoke expr =
        new StaticInvoke(UnsafeSupport.class, "getInt", PRIMITIVE_INT_TYPE, base, pos);
    if (!UnsafeSupport.IS_LITTLE_ENDIAN) {
  ...
  protected Expression unsafeGetLong(Expression base, Expression pos) {
    StaticInvoke expr =
        new StaticInvoke(UnsafeSupport.class, "getLong", PRIMITIVE_LONG_TYPE, base, pos);
    if (!UnsafeSupport.IS_LITTLE_ENDIAN) {
  ...
  protected Expression readInt16(Expression buffer) {
    String func = UnsafeSupport.IS_LITTLE_ENDIAN ? "_readInt16OnLE" : "_readInt16OnBE";
    return new Invoke(buffer, func, PRIMITIVE_SHORT_TYPE);
  }

  protected Expression readInt32(Expression buffer) {
    String func = UnsafeSupport.IS_LITTLE_ENDIAN ? "_readInt32OnLE" : "_readInt32OnBE";
    return new Invoke(buffer, func, PRIMITIVE_INT_TYPE);
  }

  public static String readIntFunc() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readInt32OnLE" : "_readInt32OnBE";
  }

  protected Expression readVarInt32(Expression buffer) {
    String func = UnsafeSupport.IS_LITTLE_ENDIAN ? "_readVarInt32OnLE" : "_readVarInt32OnBE";
    return new Invoke(buffer, func, PRIMITIVE_INT_TYPE);
  }
  ...
  public static String readLongFunc() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readInt64OnLE" : "_readInt64OnBE";
  }

  public static String readInt16Func() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readInt16OnLE" : "_readInt16OnBE";
  }

  public static String readVarInt32Func() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readVarInt32OnLE" : "_readVarInt32OnBE";
  }

  public static String readFloat32Func() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readFloat32OnLE" : "_readFloat32OnBE";
  }

  public static String readFloat64Func() {
    return UnsafeSupport.IS_LITTLE_ENDIAN ? "_readFloat64OnLE" : "_readFloat64OnBE";
  }
