...
import org.apache.fory.collection.MutableTuple3;
    ...
    List<MutableTuple3<List<Descriptor>, Integer, List<List<Descriptor>>>> groups =
        Arrays.asList(
            ...
            MutableTuple3.of(
                ...
                boxedReadGroups),
            MutableTuple3.of(
                new ArrayList<>(descriptorGrouper.getBuildInDescriptors()), 9, finalWriteGroups),
            MutableTuple3.of(
                new ArrayList<>(descriptorGrouper.getBuildInDescriptors()), 5, finalReadGroups),
            MutableTuple3.of(
