...
/**
 * Resizable list backed by a boolean array.
 *
 ...
 */
public final class BoolList extends AbstractList<Boolean> implements RandomAccess {
   ...
   */
  public BoolList(int initialCapacity) {
