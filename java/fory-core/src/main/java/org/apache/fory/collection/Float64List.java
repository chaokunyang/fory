...
/**
 * Resizable list backed by a double array for 64-bit floating values.
 *
 ...
 */
public final class Float64List extends AbstractList<Double> implements RandomAccess {
   ...
   */
  public Float64List(int initialCapacity) {
   ...
   */
  public Float64List(double[] array) {
    this.array = array;
