...
public abstract class TypeResolver {
  ...
  public final Serializer<?> getSerializer(TypeRef<?> typeRef) {
    TypeExtMeta meta = typeRef.getTypeExtMeta();
    if (meta != null && canResolveSerializerByTypeId(meta.typeId())) {
  ...
  public final boolean canResolveSerializerByTypeId(int typeId) {
    return !Types.isUserDefinedType((byte) typeId)
        && typeId != Types.UNKNOWN
        && getInternalTypeInfoByTypeId(typeId) != null;
  }
