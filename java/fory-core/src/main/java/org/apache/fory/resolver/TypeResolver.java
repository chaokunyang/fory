...
public abstract class TypeResolver {
  ...
  private TypeDef matchingLocalTypeDef(long headerHash, Class<?> cls) {
    ...
    TypeDef localTypeDef = getTypeInfo(cls, false) == null ? null : typeDefMap.get(cls);
    return localTypeDef != null && TypeDef.headerHash(localTypeDef.getId()) == headerHash
        ? localTypeDef
        : null;
  }
  ...
  class ExtRegistry {
    ...
    final MetadataLongMap<TypeInfo> typeInfoByHeaderHash = new MetadataLongMap<>(2, 0.5f);
