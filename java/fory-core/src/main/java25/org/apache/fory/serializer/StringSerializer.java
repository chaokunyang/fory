...
/**
 * String serializer based on method handles and byte-array accessors for speed.
 *
...
public final class StringSerializer extends ImmutableSerializer<String> {
  ...
  private static boolean jdkInternalFieldAccess() {
    // Native-image runtime string layout is not a HotSpot private-field contract; use public
