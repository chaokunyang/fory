...
describe("union", () => {
  ...
  test("should named union roundtrip", () => {
    ...
    const { serialize, deserialize } = fory.register(
      Type.struct(
        { namespace: "test", typeName: "Wrapper" },
        {
          payload: Type.union(
            { namespace: "test", typeName: "MyUnion" },
            {
              1: Type.string(),
  ...
  test("should named union with struct case roundtrip", () => {
    ...
    const { serialize, deserialize } = fory.register(
      Type.struct(
        { namespace: "test", typeName: "Holder" },
        {
          payload: Type.union(
            { namespace: "test", typeName: "ContentUnion" },
            {
