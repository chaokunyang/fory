...
class TypeSerializer(Serializer):
    ...
    def _inject_class_reference_into_methods(self, cls, class_dict):
        ...
        for attr_name, attr_value in class_dict.items():
            ...
            if (
                callable(attr_value)
                and hasattr(attr_value, "__code__")
                and hasattr(attr_value, "__closure__")
                and attr_value.__code__.co_freevars
            ):
                ...
                if class_name in code.co_freevars:
                    ...
                    if (
                        attr_value.__closure__
                        and len(attr_value.__closure__) > class_index
                    ):
