...
def test_struct():
    fory = Fory(language=Language.XLANG, ref=True)
...
def test_strict():
    fory = Fory(language=Language.PYTHON, ref=True)
...
def test_inheritance():
    ...
    fory = Fory(language=Language.PYTHON, ref=True, strict=False)
    obj = ChildClass1(f1="a", f2=-10, f3={"a": -10.0, "b": 1 / 3})
...
def test_data_class_serializer_xlang_vs_non_xlang():
    ...
    fory_xlang = Fory(language=Language.XLANG, ref=True)
    fory_python = Fory(language=Language.PYTHON, ref=True, strict=False)
