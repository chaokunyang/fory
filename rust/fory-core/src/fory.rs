...
impl Fory {
    ...
    ///   Unlike `register_by_id()`, this does not require `StructSerializer`, making it suitable
    ...
    ///
    /// let mut fory = Fory::default();
    /// fory.register_serializer_by_id::<MyCustomType>(200);
    /// ```
    ...
    /// # Notes
    ///
    /// This is the named equivalent of `register_serializer_by_id()`, preferred for
    ...
    /// Don't register concrete struct types with this method. Use `register_by_id()` instead.
