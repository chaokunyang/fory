    ...
    let read_value = if unsigned_type == "u32" {
        quote! {
            ...
            match _field.field_type.type_id {
                fory_core::wire::UINT32 => context.reader.read_u32()?,
                fory_core::wire::VAR_UINT32 => context.reader.read_var_u32()?,
        ...
        quote! {
            ...
            match _field.field_type.type_id {
                fory_core::wire::UINT64 => context.reader.read_u64()?,
                fory_core::wire::VAR_UINT64 => context.reader.read_var_u64()?,
                fory_core::wire::TAGGED_UINT64 => context.reader.read_tagged_u64()?,
                ...
                if let Some(unsigned_type) = is_unsigned_encoding_type(ty) {
                    ...
                    if let Some(prim_type) = is_compatible_primitive_type(ty) {
                        ...
                        quote! {
                            ...
                            let read_type_info = fory_core::wire::need_to_write_type_for_field(
                                <#ty as fory_core::Serializer>::fory_static_type_id()
                            );
