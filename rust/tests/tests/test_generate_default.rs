...
/// ForyStruct does NOT generate Default by default, so there's no conflict.
...
/// ForyStruct does NOT generate Default by default.
...
fn test_generate_default_struct() {
    ...
    // Default should work (generated by ForyStruct)
...
fn test_generate_default_enum() {
    ...
    // Default should be First variant (generated by ForyStruct)
