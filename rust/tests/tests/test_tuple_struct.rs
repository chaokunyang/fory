...
fn test_single_field_tuple_struct() {
    let mut fory = Fory::default();
    fory.register_by_id::<Single>(101).unwrap();
...
fn test_string_wrapper_tuple_struct() {
    let mut fory = Fory::default();
    fory.register_by_id::<Wrapper>(102).unwrap();
...
fn test_triple_tuple_struct() {
    let mut fory = Fory::default();
    fory.register_by_id::<Triple>(103).unwrap();
...
fn test_tuple_struct_with_vec() {
    let mut fory = Fory::default();
    fory.register_by_id::<WithVec>(104).unwrap();
...
fn test_tuple_struct_with_option() {
    let mut fory = Fory::default();
    fory.register_by_id::<WithOption>(105).unwrap();
...
fn test_tuple_struct_with_map() {
    let mut fory = Fory::default();
    fory.register_by_id::<WithMap>(106).unwrap();
...
fn test_nested_tuple_structs() {
    let mut fory = Fory::default();
    fory.register_by_id::<Inner>(107).unwrap();
    fory.register_by_id::<Outer>(108).unwrap();
...
fn test_tuple_struct_with_rc() {
    let mut fory = Fory::default();
    fory.register_by_id::<WithRc>(109).unwrap();
...
fn test_named_struct_with_tuple_struct_fields() {
    ...
    fory.register_by_id::<Point>(100).unwrap();
    fory.register_by_id::<Wrapper>(102).unwrap();
    fory.register_by_id::<NamedWithTupleStruct>(110).unwrap();
...
fn test_tuple_struct_with_tuple_field() {
    let mut fory = Fory::default();
    fory.register_by_id::<TupleStructWithTuple>(111).unwrap();
...
fn test_tuple_struct_with_empty_vec() {
    let mut fory = Fory::default();
    fory.register_by_id::<EmptyVecTuple>(112).unwrap();
...
fn test_large_tuple_struct() {
    let mut fory = Fory::default();
    fory.register_by_id::<LargeTupleStruct>(113).unwrap();
...
fn test_tuple_struct_schema_evolution_add_field() {
    ...
    fory_writer.register_by_id::<remote_v1::Point>(100).unwrap();
    ...
    fory_reader.register_by_id::<local_v2::Point>(100).unwrap();
...
fn test_tuple_struct_schema_evolution_remove_field() {
    let mut fory_writer = Fory::builder().compatible(true).build();
    fory_writer.register_by_id::<remote_v3::Point>(100).unwrap();

    let remote_data = remote_v3::Point(1.0, 2.0, 3.0, 4.0);
    let bytes = fory_writer.serialize(&remote_data).unwrap();

    let mut fory_reader = Fory::builder().compatible(true).build();
    fory_reader.register_by_id::<remote_v1::Point>(100).unwrap();
...
fn test_tuple_struct_schema_evolution_add_i64() {
    let mut fory_writer = Fory::builder().compatible(true).build();
    fory_writer
        .register_by_id::<remote_mixed_v1::MixedPoint>(100)
        .unwrap();
    ...
    let mut fory_reader = Fory::builder().compatible(true).build();
    fory_reader
        .register_by_id::<local_mixed_v2::MixedPoint>(100)
        .unwrap();
...
fn test_tuple_struct_schema_evolution_add_u8() {
    ...
    let mut fory_reader = Fory::builder().compatible(true).build();
    fory_reader
        .register_by_id::<local_mixed_v3::MixedPoint>(100)
        .unwrap();
