...
/** A closeable server-streaming RPC iterator returned by generated Scala gRPC clients.
  *
  * Generated gRPC service companions own the underlying transport call. Calling
