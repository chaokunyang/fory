 ...
 * return a [[java.util.Map]] adapter for fory java map framework to invoke.</li>
 * <li>Fory java map framework write all map elements by fory protocol.</li>
 *
 ...
 * </li>
 * <li>Fory java map framework read all map elements by fory protocol,
 ...
 *
 */
class ScalaMapSerializer[K, V, T <: scala.collection.Map[K, V]](
 ...
 *
 */
class ScalaSortedMapSerializer[K, V, T <: scala.collection.SortedMap[K, V]](
    typeResolver: TypeResolver,
    cls: Class[T])
  extends AbstractScalaMapSerializer[K, V, T](typeResolver, cls) {
  override def onMapWrite(
