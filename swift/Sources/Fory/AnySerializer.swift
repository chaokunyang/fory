...
@inline(__always)
private func reserveAnyReferenceMapMemory<Map>(_ context: ReadContext, _ type: Map.Type, count: Int)
  throws
{
...
extension AnyHashable: Serializer {
  ...
  public static func foryReadCompatibleData(_ context: ReadContext, remoteTypeInfo: TypeInfo) throws
    -> AnyHashable
  {
...
struct SerializableAny: Serializer {
  ...
  static func foryReadCompatibleData(_ context: ReadContext, remoteTypeInfo: TypeInfo) throws
    -> SerializableAny
  {
    let typeInfo = remoteTypeInfo
    if typeInfo.typeID == .none {
