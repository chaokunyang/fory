...
public protocol FieldCodec {
  ...
  static func withTypeInfo<R>(_ typeInfo: TypeInfo?, _ context: ReadContext, _ body: () throws -> R)
    rethrows -> R
...
private func readIntArrayPayload(_ context: ReadContext, reserveGraphStorage: Bool = false) throws
  -> [Int]
{
...
private func readUIntArrayPayload(_ context: ReadContext, reserveGraphStorage: Bool = false) throws
  -> [UInt]
{
