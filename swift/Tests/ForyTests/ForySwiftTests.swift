...
func namedInitializerBuildsConfig() {
    ...
    #expect(explicitConfig.config.maxGraphMemoryBytes == 65_536)
    ...
    #expect(configInit.config.maxGraphMemoryBytes == 131_072)
...
@Test
func localNonStructMetaBypassesCache() throws {
